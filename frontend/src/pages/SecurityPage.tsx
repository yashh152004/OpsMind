    ...
    <div className="space-y-8 pb-20 page-transition">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
           <button className="btn-secondary h-9 text-xs">Compliance Report</button>
           <button className="btn-primary h-9 text-xs">Run Deep Scan</button>
        </div>
      </div>

      <div className="grid gap-6 md:grid-cols-3">
         <div className="enterprise-card p-6 border-l-4 border-l-destructive">
            ...
            <div className="text-3xl font-bold font-mono">{findings?.filter((f:any) => f.severity === 'HIGH').length || 0}</div>
            <p className="text-[10px] text-muted-foreground mt-2 font-bold uppercase tracking-tighter">Requires immediate remediation</p>
         </div>
         <div className="enterprise-card p-6 border-l-4 border-l-primary">
